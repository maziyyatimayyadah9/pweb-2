...
<body>
   ...
   <nav class="navbar navbar-expand-lg text-uppercase" style="background-color: #008B8B">
        <div class="container">
            <a class="navbar-brand" href="index.php" style="color: #FF1493">PEREKAMAN DATA LAPTOP</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" aria-current="page" href="index.php"style="color: #FF1493"> Home</a>
                    </li>
                    <li class="nav-item">
